	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="Claim">Claims</a>
				</li>
			</ul>
			<span class="navbar-text" style="color: white"> Welcome, <strong>
					<%=(String) session.getAttribute("username")%>
			</strong>!
			</span> <a class="btn btn-outline-secondary my-2 my-sm-0 btn-logout"
